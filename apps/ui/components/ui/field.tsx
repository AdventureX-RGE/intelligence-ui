  ...
  return (
    <InputPrimitive
      ...
      className={composeTailwindRenderProps(
        className,
        "w-full min-w-0 bg-bg-1 px-2.5 py-2 text-base text-fg placeholder-muted-fg outline-hidden data-focused:outline-hidden sm:text-sm/6 [&::-ms-reveal]:hidden [&::-webkit-search-cancel-button]:hidden [&:not(:focus):not(:placeholder-shown)]:bg-bg-3",
      )}
    />
  )
}
