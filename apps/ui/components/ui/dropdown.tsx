...
const dropdownItemStyles = tv({
  base: [
    ...
    "group relative cursor-default select-none rounded-[calc(var(--radius-lg)-1px)] px-[calc(var(--spacing)*2.3)] py-[calc(var(--spacing)*1.3)] forced-color:text-[Highlight] text-fg text-sm outline-0 forced-color-adjust-none sm:text-sm/6 forced-colors:text-[LinkText]",
