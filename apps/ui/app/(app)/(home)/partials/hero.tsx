      ...
      <div className="border-b pt-10 pb-6 sm:py-8 lg:py-10 xl:py-20 2xl:py-24">
        <Container>
          <Header className="text-center sm:text-left">
            ...
            <h1 className="mt-4 mb-4 max-w-6xl bg-linear-to-r from-zinc-900 to-zinc-600 bg-clip-text pb-1 font-semibold text-3xl text-transparent tracking-tight lg:mb-6 lg:text-6xl dark:from-orange-400 dark:to-orange-200">
