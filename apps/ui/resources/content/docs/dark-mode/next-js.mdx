...
Add suppressHydrationWarning to the html tag to avoid the hydration error. You can check the [Next-Themes documentation](https://github.com/pacocoursey/next-themes?tab=readme-ov-file#with-app) for more information.
