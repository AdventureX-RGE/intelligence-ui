...
After running the `init` command, a `.justd` file will appear in your project. This file holds your project's configuration, including settings for gray tones, paths, and more.
