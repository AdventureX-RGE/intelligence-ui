...
<Note intent="info">
  <p>
    Running this command will overwrite your **main css** file. It is
    recommended to use this in a **new project** rather than an existing one to
    avoid manual file additions.
  </p>
</Note>
...
Visit our documentation at: https://ui.adventure-x.org

Now try to add some components to your project
by running: npx intelligence-cli@latest add
...
### Intelligence-UI Config

After running the `init` command, a `.intelligence` file will appear in your project. This file holds your project's configuration, including settings for gray tones, paths, and more.

```
{
  "$schema": "https://ui.adventure-x.org/schema.json",
...
<Installation
  options={{ isComponent: true, noText: true }}
  items={["combo-box"]}
/>
...
<Installation
  options={{ isComponent: true, noText: true }}
  items={["select", "text-field"]}
/>
If you need to include grouped components, refer to the documentation which organizes
related components under a single namespace, such as collections, overlays, and forms.
This allows you to add them all at once, like so:
...
``` ✓ button created ✓ dialog created ✓ modal created ✓ sheet created ✓ drawer created
✓ popover created ✓ tooltip created ```
...
This command will present a list of available components, which you can navigate
and select using the arrow keys and spacebar.
...
<Installation
  ...
  command="npx intelligence-cli@latest diff"
  items={[""]}
/>
...
<Installation
  command="npx intelligence-cli@latest diff multiple-select menu modal"
  items={[""]}
/>
...
<Note intent="info">
  Got a starter kit for something else, like Remix or Astro? Consider submitting
  a [PR](https://github.com/justdlabs/next.js/issues/new) to help expand our
  list!
</Note>
...
<Installation command="npx create-next-app@latest -e https://github.com/justdlabs/next.js project-name" />

### Remix

Interested in Remix? Dive into the [Remix Starter Kit](https://github.com/justdlabs/remix), crafted by [José Miguel](https://github.com/m1guer). Here’s how to get started:

<Installation command="npx create-remix@latest --template justdlabs/remix" />

### Tanstack Router

The starter kit for Tanstack Router is available [here](https://github.com/justdlabs/tanstack-router). Start with this command:

<Installation command="git clone https://github.com/justdlabs/tanstack-router.git tanstack-router-app" />
After cloning the repository, navigate to the `tanstack-router-app` directory and
run the following command to install the dependencies and start the development server:
<Installation command="npm i && npm run dev" />
...
Intelligence-UI utilizes the <NewTab href='https://biomejs.dev/'>Biome</NewTab> formatter for code formatting. To use the Biome formatter with Intelligence-UI components, we recommend the following configuration:
...
<Installation
  ...
  items={["react-aria-components", "tailwindcss-react-aria-components"]}
/>
...
```css
@theme {
  --font-sans: var(--font-inter-sans), ui-sans-serif, system-ui, sans-serif,
    "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
  --font-mono: var(--font-geist-mono), ui-sans-serif, system-ui, sans-serif,
    "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
...
Intelligence-UI supports dark mode out of the box. Every framework has its own way of implementing dark mode. So you better check the docs list below:
