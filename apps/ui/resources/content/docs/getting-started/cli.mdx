---
title: "CLI"
description: "The CLI isn’t the only way to install Justd, but it’s by far the most convenient. It’s built to make setting up your project fast and hassle-free."
order: 4
published: true
---
...
<Installation
  ...
  command="npx justd-cli@latest diff"
  items={[""]}
/>
...
<Installation
  ...
  command="npx justd-cli@latest change-gray"
/>
...
<Installation
  options={{ isExecutor: true }}
  command="npx justd-cli@latest -y"
  items={[""]}
/>
...
<Installation
  options={{ isExecutor: true }}
  command="npx justd-cli@latest init --force"
  items={[""]}
/>
...
<Installation
  options={{ isExecutor: true }}
  command="npx justd-cli@latest help"
  items={[""]}
/>
