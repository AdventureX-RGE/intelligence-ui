...
Intelligence-UI is more than just a design system. It is a comprehensive toolkit designed to make creating accessible, visually stunning, and highly customizable user interfaces effortless. Built on top of **React Aria Components**, Intelligence-UI leverages their accessibility-first approach to ensure your designs are inclusive and meet modern accessibility standards, allowing you to focus on delivering exceptional user experiences.

**Why choose Intelligence-UI?** It includes **Tailwind CSS** for seamless, modern styling, a beautifully crafted icon library to enhance your designs, and a robust color system offering four formats and **shades from 50 to 950**. This flexibility ensures your designs are consistent, scalable, and visually appealing.
...
Want to move fast without spending hours building components? No problem! **[Intelligence-UI Blocks](https://blocks.getjustd.com)** offers a collection of ready-to-use components, covering everything from **Application** and **Marketing** to **Charts** and **Commerce**. Easily customize them to fit your needs and build faster than ever.

## FAQ

This is a list of frequently asked questions about Intelligence-UI.
