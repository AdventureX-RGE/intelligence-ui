---
title: "Release Notes"
description: "All releases made to Intelligence-UI, detailing every update and enhancement introduced to the platform, providing a comprehensive overview of changes and improvements."
order: 1
published: true
---
...
- Add searchable select to [select](https://ui.adventure-x.org/select)
...
Below is a list of all the releases that have been made to Intelligence-UI

If you don't see the release you're looking for, please run `npx intelligence-cli@latest diff` to see the changes. Not sure? Look at this [installation page](/docs/getting-started/installation#diff).
...
- A lot of improvements to Intelligence-UI CLI (when this was written, the version v1.2.16)
...
If you're using initial setup (`npx intelligence-cli@latest init`), do not worry about this. It will be automatically added to your project.
...
- Add information to cli `npx intelligence-cli@latest help`
...
- Move CLI from `@irsyadadl/d` to `intelligence-cli`
