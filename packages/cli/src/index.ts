 ...
 *  You can also add multiple components at once by separating them with a space (npx intelligence-cli@latest add aside avatar button)
 *  You can also all by using (npx intelligence-cli@latest add) then just press `a` and then `enter`
 ...
 *  You can see the full theme list here: https://ui.adventure-x.org/themes
